...
class Snippets:
    ...
    def decode_transaction(self):
        ...
        txid = tx.GetHash().hex()
        inputs = [{'txid': i.prevout.hash.hex(), 'vout': i.prevout.n, 'sequence': i.nSequence} for i in tx.vin]
    ...
    def recipient_count(self):
        return len(self.decoded_dataframe)
    
    def enrich_context_with_parquet_file(self,path_to_parquet_file,on_col_name="addresses"):
        ### Be sure that the parquet file has a column named "addresses"
