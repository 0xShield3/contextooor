...
def decode_transaction(tx_hex):
    ...
    outputs = [{'addresses': decode_script(o['script']), 'value': o['value']} for o in tx['outs']]
...
# decoded_tx = decode_transaction(tx_hex)
# decoded_tx_frame=get_frame(decoded_tx)
# print(contains_sanctioned_addresses(decoded_tx_frame))
# print(total_value(decoded_tx_frame,denomination="bitcoin"))
# print(value_to(decoded_tx_frame,"32KUV7TfdhmY5gGdemGUm7mYr31S56BpHb",denomination="bitcoin"))
