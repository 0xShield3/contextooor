...
# decoded_tx = BitcoinUtils().decode_transaction(tx_hex)
# decoded_tx_frame=BitcoinUtils().get_frame(decoded_tx)
# print(BitcoinUtils().contains_sanctioned_addresses(decoded_tx_frame))
# print(BitcoinUtils().total_value(decoded_tx_frame,denomination="bitcoin"))
# print(BitcoinUtils().value_to(decoded_tx_frame,"32KUV7TfdhmY5gGdemGUm7mYr31S56BpHb",denomination="bitcoin"))
