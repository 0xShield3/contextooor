...
from contextooor.core.addresses import Addresses
...
class Snippets:
    ...
    def __init__(self,w3=Web3(Web3.HTTPProvider("https://eth.public-rpc.com")),block='latest',suppress_errors=True):
        ...
        self.addrs=Addresses(w3=self.web3)
    ...
    def getSlippage(self,to_address,input_data,value=None):
        try:
            ...
            if router == 'v3_router_1':
                self.uniswapV3_router.setRouter(isrouter_1=True)
            if router == 'v3_router_2':
                self.uniswapV3_router.setRouter(isrouter_1=False)
